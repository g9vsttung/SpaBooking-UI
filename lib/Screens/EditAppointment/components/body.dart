...
class BodyEditAppointment extends StatefulWidget {
  Spa spa;
  BodyEditAppointment({required this.spa});

  @override
  State<StatefulWidget> createState() {
    return _BodyEditAppointment();
  }
}

class _BodyEditAppointment extends State<BodyEditAppointment> {
  ...
  Widget build(BuildContext context) {
    thisDate = DateTime.parse(widget.spa.date);
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return AppointmentScreen( date: selectedDate.toString().split(" ")[0], time: selectedTime);
                  },));
                },
                child: Text(
                  "Edit",
